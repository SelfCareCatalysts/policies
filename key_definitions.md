...
* *Application*: An application hosted by Self Care Catalysts, either maintained and created by Self Care Catalysts, or maintained and created by a Customer or Partner.

* *Application Level*: Controls and security associated with an Application. In the case of PaaS Customers, Self Care Catalysts does not have access to and cannot assure compliance with security standards and policies at the Application Level.
...
* *Backup Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Self Care Catalysts Add-ons and as an option for PaaS Customers.
...
* *Customers*: Contractually bound users of Self Care Catalysts Platform.
...
* *Event*: An event is defined as an occurrence that does not constitute a serious adverse effect on Self Care Catalysts, its operations, or its Customers, though it may be less than optimal. Examples of events include, but are not limited to:
...
* *IDS Service*: An Intrusion Detection Service for providing IDS notification to customers in the case of suspicious activity. Offered with all Self Care Catalysts Add-ons and as an option for PaaS Customers.
...
* *Logging Service*: A logging service for unifying system and application logs, encrypting them, and providing a dashboard for them. Offered with all Self Care Catalysts Add-ons and as an option for PaaS Customers.
...
* *Organization*: For the purposes of this policy, the term “organization” shall mean Self Care Catalysts.

* *Partner*: Contractual bound 3rd party vendor with integration with the Self Care Catalysts Platform. May offer Add-on services.

* *Platform*: The overall technical environment of Self Care Catalysts.
...
* *Security Incident* (or just Incident): A security incident is an occurrence that exercises a significant adverse effect on people, process, technology, or data. Security incidents include, but are not limited to: 
	...
	* Unauthorized change or destruction of ePHI (i.e. delete dictation, data alterations not following Self Care Catalysts’s procedures);
...
* *Vendors*: Persons from other organizations marketing or selling products or services, or providing services to Self Care Catalysts. 
