...
Self Care Catalysts takes data integrity very seriously. As stewards and partners of Self Care Catalysts Customers, we strive to assure data is protected from unauthorized access and that it is available when needed. The following policies drive many of our procedures and technical settings in support of the Self Care Catalysts mission of data protection.
...
* All access to Production Systems must be logged. This is done following the Self Care Catalysts Auditing Policy.
...
* All Production Systems are to only be used for Self Care Catalysts business needs.

### Patch Management

* Patches, application, and system OS versions are kept up to date at all times. New versions are tested.
* Administrators subscribe to mailing lists to assure up to date on current version of all Self Care Catalysts managed software on Production Systems.
...
* Ensure Self Care Catalysts customer Production Data is segmented and only accessible to customer authorized to access data.
...
* In the case of Self Care Catalysts provided APIs, provide mechanisms to assure person sending or receiving data is authorized to send and save data.
